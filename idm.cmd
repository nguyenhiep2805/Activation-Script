...
if not exist "%_psc%" (
%nceline%
echo Powershell chua duoc cai dat.
echo Dang huy bo...
goto done2
)
...
echo Script nay chi ho tro Windows 7/8/8.1/10/11 va may chu tuong duong.
goto done2
)
...
%nceline%
echo Script nay yeu cau quyen administrator.
echo Hay nhap chuot phai vao script nay va chon 'Run as administrator'.
goto done2
)
...
cls
title  Scirpt kich hoat IDM - @HiepCode
mode 65, 25
...
call :_color2 %_White% "        " %_Green% "  Duoc tao boi Hiep Code"
echo:          _____________________________________________   
echo: 
echo:          Facebook: nguyenhiep.me/facebook
echo:          Github: nguyenhiep.me/github
echo:          _____________________________________________   
echo:                                                          
echo:          [1] Kich hoat IDM                                
echo:          [2] Reset dung thu
echo:          _____________________________________________   
echo:                                                          
call :_color2 %_White% "          [3] Tuong lua  " %_col% "[%_status%]"
echo:          _____________________________________________   
echo:                                                          
echo:          [4] Huong dan                                      
echo:          [5] Trang chu                                  
...
echo:   
call :_color2 %_White% "        " %_Green% "Nhap mot tuy chon [1, 2, 3, 4, 5, 6]"
choice /C:123456 /N
set _erl=%errorlevel%
...
set "_ReadMe=%SystemRoot%\Temp\Huong dan.txt"
...
call :_color %Green% "Kich hoat IDM - Ban dung thu duoc thiet lap lai thanh cong."
) else (
call :_color %Red% "Khong the thiet lap lai hoan toan IDM - Ban dung thu."
)
...
echo Ban co the tai no tu https://www.internetdownloadmanager.com/download.html
goto done
)
...
if not [%errorlevel%]==[0] (
call :_color %Red% "Khong the ket noi den internetdownloadmanager.com, dang huy..."
goto done
)
...
echo:
call :_color %Gray% "Neu thong bao Fake serial key xuat hien, hay chay lai Script nay."
goto done
)
...
echo:
echo:
echo Dang tro ve Trang chu...
echo:
echo:
timeout /t 3

start https://bio.nguyenhiep.me
goto MainMenu
...
echo %line%
echo:
call :_color %Red% "Da tim thay loi, dang dat lai kich hoat IDM..."
set "_action=call :delete_key"
call :reset
echo:
echo %line%
...
echo:
echo Dang thiet lap thong tin dang ky...
echo:
...
echo:
echo Dang kich hoat thu nghiem, vui long doi...
...
echo Khoa dang ky da duoc tao thanh cong.
) else (
if not defined _fileexist call :_color %Red% "Khong the tai tep tin voi IDM."
call :_color %Red% "Khong the tao khoa dang ky."
call :_color %Magenta% "Hay thu lai - Tat tuong lua Windows bang cac tuy chon Script - Kiem tra phan Huong dan."
)
...
_________________________________
 ...
 - Script nay ap dung phuong phap khoa registry de kich hoat IDM.

 - Phuong phap nay yeu cau ket noi internet tai thoi diem kich hoat.

 - Cac ban cap nhat IDM co the duoc cai dat truc tiep ma khong can phai kich hoat lai.

 - Sau khi kich hoat, neu xuat hien thong bao Fake serial key hay chay lai script nay.
...
_________________________________
 ...
 - IDM cung cap thoi gian dung thu 30 ngay, ban co the dung scirpt nay de dat lai thoi gian dung thu bat cu khi nao ban muon.
 
 - Tuy chon nay cung co the dung de khoi phuc trang thai neu trong truong hop IDM thong bao Fake serial key hoac cac loi tuong tu khac.
...
_________________________________
 ...
 - Script nay chi ho tro Windows 7/8/8.1/10/11 va may chu tuong duong.
...
_________________________________
   ...
   - De tuy chinh thong tin dang ky IDM, hay sua dong so 5 trong script.
   - De kich hoat trong che do unattended, hay chay script voi tham so /act.
   - De dat lai trong che do unattended, hay chay script voi tham so /res.
   - De bat che do silent bang hai phuong phap tren, hay chay script voi tham so /s.
...
_________________________________
   ...
   Script kich hoat IDM
   
   Website:	bio.nguyenhiep.me
   
   Facebook: nguyenhiep.me/facebook
